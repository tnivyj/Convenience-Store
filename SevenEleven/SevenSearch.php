...
<!--        search-->
        <script>
            function search(){
                /* 取得输入内容 */
                var search_Sname = document.getElementById('search_Sname').value;
                var searchs = {searchSname: search_Sname};
                var myUrl = "SevenDB/SevenDBSearch.php";
                $.ajax({
                    url: myUrl,
                    type: 'POST',
                    data: searchs,
            ...
            <div id="divSearch" class="store">
                <div class="leftInput" style="font-size:20px; width:40%;">
                    ...
                    <table>
                        <tr>
                            <td>门市店名</td>
                            <td><input type="text" id="search_Sname" placeholder="请输入门市店名" maxlength="5" class="input"></td>
                        </tr>
                    </table>
                    <input type="button" value="查询" onclick="search()" id="btnSearch" class="btn"><br><br>
