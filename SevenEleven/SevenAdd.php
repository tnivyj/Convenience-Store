        ...
        <script>
            ...
            $(document).ready(function(){
                ...
                $("#update").click(function(){
                    window.location.href = "SevenUpdate.php";
                });
...
<!--        add-->
        <script>
            function checkadd(){
                ...
                var mySno = $('#add_Sno').val();
                var mySlocation = $('#add_Slocation').val();
                var mySphone = $('#add_Sphone').val();
                if(mySno == '' && mySlocation == ''){
            ...
            function add(){
                /* 取得输入内容 */
                var add_Sno = document.getElementById('add_Sno').value;
                var add_Sname = document.getElementById('add_Sname').value;
                var add_Slocation = document.getElementById('add_Slocation').value;
                var add_Sphone = document.getElementById('add_Sphone').value;
                var adds = {addSno: add_Sno, addSname: add_Sname, addSlocation: add_Slocation, addSphone: add_Sphone};
                var myUrl = "SevenDB/SevenDBAdd.php";
                $.ajax({
                    url: myUrl,
                    type: 'POST',
                    data: adds,
...
//                        console.log(textStatus);
                ...
                function showAdd(){
                    ...
                    str += '<tr><td>门市店号</td><td>' + add_Sno + '</td></tr>';
                    str += '<tr><td>门市店名</td><td>' + add_Sname + '</td></tr>';
                    str += '<tr><td>门市地址</td><td>' + add_Slocation + '</td></tr>';
                    str += '<tr><td>门市电话</td><td>' + add_Sphone + '</td></tr>';
                    str += '</table>';
//                    $("#demoAdd").append(str);
                    document.getElementById("demoAdd").innerHTML = str;
//                    清空输入内容
                    document.getElementById("add_Sno").value = "";
                    document.getElementById("add_Sname").value = "";
                    document.getElementById("add_Slocation").value = "";
                    document.getElementById("add_Sphone").value = "";
                }
            }
        </script>
    </head>
            ...
            <div id="divAdd" class="store">
                <div class="leftInput" style="font-size: 20px;">
                    ...
                    <table>
                        <tr>
                            <td>门市店号</td>
                            <td><input type="text" id="add_Sno" placeholder="请输入门市店号" maxlength="6" class="input"></td>
                        </tr>
                        <tr>
                            <td>门市店名</td>
                            <td><input type="text" id="add_Sname" placeholder="请输入门市店名" maxlength="5" class="input"></td>
                        </tr>
                        <tr>
                            <td>门市地址</td>
                            <td><input id="add_Slocation" placeholder="请输入门市地址" maxlength="30" class="input"></td>
                        </tr>
                        <tr>
                            <td>门市电话</td>
                            <td><input type="text" id="add_Sphone" placeholder="ex:XX-XXXXXXX" maxlength="10" class="input"></td>
                        </tr>
                    </table>
                    <input type="button" value="新增" onclick="checkadd()" id="btnAdd" class="btn">
